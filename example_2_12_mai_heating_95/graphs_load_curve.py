...
def daily_heating_curve():
    ...
    file = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_12_mai_heating_95//heating_electric_m2_0.csv", header=None, index_col=None, sep=",")
    for i in range(365):
        ind_begin = i*96
        ind_end = (i+1)*96
        for j in range(24):
    ...
    plt.title("Electric consumption related to heating")
    plt.show()
