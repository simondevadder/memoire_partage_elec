...
def func_1():
    ...
    #file_2 = "C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/unconst_otherdata/resultats_simulations_unconst_other_data_combined_2.csv"
...
def func_2():
    file_1 = "C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/unconst_correct_data/resultats_simulations_unconst_capex_03_begin.csv"
    file_2 = "C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/unconst_correct_data/resultats_simulations_unconst_capex_03.csv"
    ...
    df_merged.to_csv("C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/unconst_correct_data/resultats_simulations_unconst_capex_03_merged.csv", index=False)

#func_2()

def twenty_households_pv_area():
    file = "C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/20households_pv_area/resultats_twenty_households.csv"
    df = pd.read_csv(file)
    # print(df)
...
def twenty_households_heat_map_bat_capex():
    df = pd.read_csv("C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/resultats_capex_battery_merged.csv")
    ...
    df["capex_battery"] = df["capex_battery"] * 1000  # Convert to euros
    ...
    df["lcoe_with"] = df["lcoe_with"] * 100000  # Convert to MWh if needed
    ...
    plt.figure(figsize=(10, 8))
    sns.heatmap(heatmap_data_lcoe, annot=True, fmt=".1f", cmap="YlOrRd")
    plt.xlabel("Battery Capex (euros/kWh)")
    plt.ylabel("Injection price (euros/kWh)")
    plt.title("LCOE with battery (eur/MWh)")
    plt.show()
...
def merging_capex():
    ...
    df1 = pd.read_csv("C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/resultats_capex_battery.csv")
    df2 = pd.read_csv("C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/resultats_capex_battery_2.csv")
    ...
    df_merged.to_csv("C:/Users/simva/OneDrive/Documents/1 Master 2/Mémoire/code/memoire_partage_elec/new/resultats_capex_battery_merged.csv", index=False)
