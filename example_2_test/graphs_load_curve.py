...
def load_curve(): 
    ...
    day_count = 0
    df = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_test//consumption_2.csv", header=None, index_col=None, sep=",")
    df_2 = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_test//wh.csv", header=None, index_col=None, sep=",")
    df_3 = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_test//cooking.csv", header=None, index_col=None, sep=",")
    df_4 = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_test//cold.csv", header=None, index_col=None, sep=",")
    df_5 = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_test//washing.csv", header=None, index_col=None, sep=",")
    df_6 = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_test//heating_electric_m2_0.csv", header=None, index_col=None, sep=",")
    df_7 = pd.read_csv("C://Users//simva//OneDrive//Documents//1 Master 2//Mémoire//code//memoire_partage_elec//example_2_test//other.csv", header=None, index_col=None, sep=",")
    ...
    for j in range(35040):
        ...
        heating_jour[j-ind_begin] += df_6.iloc[j,0]
